...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
		     ...
		     KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(_FUNCTIONS), KC_SPC, KC_RGUI,  KC_RALT, KC_NO, KC_RCTL, KC_MUTE
		     ),
  ...
  [_FUNCTIONS] = LAYOUT(
			...
			KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_FUNCTIONS),  KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
			),
